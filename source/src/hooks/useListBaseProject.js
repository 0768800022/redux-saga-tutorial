...
const useListBaseProject = ({
    ...
    const { execute: executeGetList } = useFetch({ ...apiConfig.getList,authorization: `Bearer ${userTokenProject}` });
    const { execute: executeDelete } = useFetch({ ...apiConfig.delete,authorization: `Bearer ${userTokenProject}` });
...
export default useListBaseProject;
